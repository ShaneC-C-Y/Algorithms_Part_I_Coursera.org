...
public class Point implements Comparable<Point> {
    ...
    public static void main(String[] args) {
        /* YOUR CODE HERE */
        Point p = new Point(230, 49);
        Point q = new Point(24, 66);
        Point[] three = new Point[3];
        three[0] = p;
        three[1] = q;
        three[2] = new Point(58, 180);

        System.out.println(p.slopeTo(q));
        System.out.println(p.slopeTo(three[2]));
//        System.out.println(p.SlopeOrder.compare(q, three[2]));
        Arrays.sort(three);
        for (Point g : three)
